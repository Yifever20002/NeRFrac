...
def psnr(img1, img2):
    ...
    res1B = psnr_1(img1[0], img2[0])
    res1G = psnr_1(img1[1], img2[1])
    res1R = psnr_1(img1[2], img2[2])

    psnr = (res1B + res1G + res1R) / 3
...
def psnr_1(img1, img2):
    ...
    if mse < 1e-10:
        return 100
    psnr_1 = 20 * math.log10(255 / math.sqrt(mse))
    return psnr_1
...
def ssim(img1, img2):
    ...
    res1B = ssim_1(img1[0], img2[0])
    res1G = ssim_1(img1[1], img2[1])
    res1R = ssim_1(img1[2], img2[2])
    
    ssim = (res1B + res1G + res1R) / 3
